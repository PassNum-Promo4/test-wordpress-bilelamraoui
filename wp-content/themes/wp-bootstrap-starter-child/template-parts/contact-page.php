...
?>
    <section id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
					<div class=" container w-100 col-12 row ">
				  <div class="row col-12  d-flex justify-content-center " >
					...
					<div class="col-12 row d-flex justify-content-center ">
						<form class="col-lg-8 col-md-12 col-sm-12 row  " action="index.html" method="post" required>
							<div class="col-12">
							...
							<div class="col-12 row d-flex justify-content-start m-3  ">
								...
								<input class="col-8 form-control" type="text" name="nom" value="AMRAOUI" required>
							</div>
							<div class="col-12 row d-flex justify-content-start m-3  ">
								<label for="#prenom" class="col-4" for="">Prenom :</label>
								<input id="prenom" class="col-8 form-control" type="text" name="prenom" value="bilel" required>
							</div>
							<div class="col-12 row d-flex justify-content-start m-3">
								<label for="#email" class="col-4" for="">Email :</label>
								<input id="email" class="col-8 form-control" type="mail" name="mail" value="bilel-amraoui@outlook.fr" required>
							</div>
							<div class="col-12 row d-flex justify-content-start m-3">
								<label for="#object" class="col-4" for="">Object :</label>
								<input id="object" class="col-8 form-control" type="text" name="objet" value="Sujet" required>
							</div>
							<div class="col-12 row d-flex justify-content-start m-3">
								<label for="#message" class="col-12" for="">Message :</label>
							<textarea id="message" class="col-12 form-control" name="message" rows="8" cols="80" required></textarea>
							</div>
							<div class="col-12 row d-flex justify-content-center">
								<input class="col-5  m-3" type="submit" name="button" value="Envoyer">
							</div>
